#!/usr/bin/env bash
# TorBox signup via Tor SOCKS5 + FlareSolverr (bypasses Cloudflare JS challenge)
# Requires: Tor on 127.0.0.1:9050, FlareSolverr on 127.0.0.1:8191, PySocks (pip install PySocks)
set -euo pipefail
