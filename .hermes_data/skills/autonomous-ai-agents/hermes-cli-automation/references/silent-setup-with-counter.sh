#!/usr/bin/env bash
# Silent setup with single-line progress counter
# Pattern: run heavy setup in background, show counter until hermes launches
# Place at: scripts/hermes.sh (user-facing entry point)
...
(
    # --- All setup commands here, output suppressed ---
